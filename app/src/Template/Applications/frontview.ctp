...
<head>
    ...
    <title>Submission Successful | Metrorooms</title>
</head>
...
<section class="contact-section">
    <div class="container">
        ...
        <div class="inline_field">
            ...
            <b> We will get back to you in one to two weeks! You will be notified if to attend an interview with the landlady</b>
        </div>
        <br>
        <br>
        <div>
        ...
        <div class = "inline_field">
            <?php
            echo $this->Html->Link(
                    '<p class="fa fa-file-o inline_field" style="color:white;margin-bottom: 0;padding-bottom: 0;;"></p>&nbsp;<p class="inline_field" style="color:white; margin-bottom: 0;padding-bottom:0;">Print this page</p>',
                    [],
                    ['id' => 'printButton', 'escape'=>false, 'style' => 'text-align:center height:12px; padding-top:5px;', 'onclick' => 'printFunction()', 'class'=> 'btn btn-warning']
            );
            ?>
          <!--  <button id="printButton" style="text-align:center height:12px; margin-top:5px;padding-top:5px;" onclick="printFunction()" class="btn btn-warning btn-large fa fa-file-o">   </button>-->
        </div>
        </div>
        <br>
        <!-- <span>Your Application Number is <?= h($application->id) ?></span>. -->
        <h4>Please take note of the date and the main contact information you given.</h4>
                ...
                <div class="row">
                    ...
                    if ($other_r != null){
                        ...
                        foreach ($images as $image) {
                            $path = "../../img/property/".$image->property_id."/room/".$image->room_id."/".$image->photo_name;
                           // $path = "/team107/team107-app/app/img/property/".$image->property_id."/room/".$image->room_id."/".$image->photo_name;
                            break;
                        }
                        if ($path == ''){
                            $path = '../../img/placeholder.jpg';
                            // /team107/team107-app/app/img/placeholder.jpg
                        }
                        ...
                        <div class="col-lg-12">
                            <div class="room-items">
                                ...
                                <!-- http://ie.infotech.monash.edu/team107/team107-app/app/rooms/detail/ -->
                                <a href="<?php echo "../../rooms/detail/" . $other_r->id; ?>">
                                ...
                                <div class="room-text">
                                    <div class="room-details">
                                        <div class="room-title">
                                            <a href="<?php echo "../../rooms/detail/".$other_r->id; ?>"><h5
                                    ...
                                    <div class="room-info">
                                        <div><p class="inline_field" style="padding-bottom: 0; margin-bottom: 0;">Room Type: &nbsp;</p><?php echo "<h7 class='inline_field'><b>".$r_t."</b></h7>";?></div>
                                        <!--<div><p class="inline_field" style="padding-bottom: 0; margin-bottom: 0;">Room Capacity: &nbsp;</p> <?php /*echo "<h7 class='inline_field'><b>".$room->current_number_of_people_staying."/".$room->room_capacity."</b></h7>"; */?></div>-->
                                    </div>
