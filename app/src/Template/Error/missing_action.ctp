...
<div class="error-wall load-error">
    <div class="error-container">
        ...
        <h4>Error 500</h4>
        <h5>Missing Action - This action does not exist.</h5>
        <p>Sorry...please check back later or click <b><u><a href="http://ie.infotech.monash.edu/team107/team107-app/app/">here</u></b></a> to return to the homepage.</p>
