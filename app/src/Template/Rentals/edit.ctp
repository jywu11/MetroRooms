...
<head>
    ...
    <title>Edit Rental | Admin</title>
    <?php $this->assign("title","Edit Rental | NAIM Admin"); ?>
</head>
<!-- end of head -->
...
<input type="hidden" id="rm_counter" value="0">
<!-- total room cap -->
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="inline_field">
            ...
            <ul class="breadcrumb inline_field">
                ...
                <li>
                    ...
                    echo $this->Html->link(
                        'View',
                        ['controller' => 'Rentals', 'action' => 'view', $this_rental->id],
                        ['confirm' => 'Are you Sure to leave this page?\nAll your unsaved changes will be lost.',
                            'class' => '']
                    );
                    ?>
        ...
        <div class="module">
            ...
            <div class="module-body">
                <div class="form-horizontal row-fluid">
                    <h2 style="text-align: center">Edit Rental Information</h2>
                    <hr>
                        ...
                        <div style="color:black; border-radius:3px; margin-top:3px; margin-bottom:10px;background-color: #ecfaff; ">
                            <div style="padding: 5px; padding-bottom:0;">
                                ...
                                <div>
                                    ...
                                    <?php
                                    if (count($rentals) == 0){
                                        echo "<p>The room currently has no active rental except this rental you are editing.</p>";
                                    }
                                    else{
                                        $counter = 1;
                    ...
                    <div class="input-group date">
                        <div>
                            <?php
                           // debug($rental);
                            $date_display = $rental->start_date->format('d/m/Y');
                            //debug($date_display);
                            //debug($rental->start_date);
                            //debug($rental);
                ...
                <div>
                    <div>
                        ...
                        <div class="inline_field">
                            ...
                            echo "<span>If you don't have an Australian phone number, please enter your country code before the phone number. Possible format: +86 18844576263</span><br><br>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    $this->Form->unlockField('tenant.rm');
                    for ($i=0; $i<1000; $i++){
                    ...
                    if ($room->room_type==0){                                                               // Private Room Beds
                        ...
                        foreach ($avaBeds as $ab){
                            $checked = 0;
                            // display all the beds by default
                            echo "<div class='sharedRoomBedCheck' id='sharedRoomBedCheck".$id_array[$counter]."' style=''>
                                                        <div class=\"inline_field\">".
                                $this->Form->control('beds_rooms._ids.'.$id_array[$counter],
                                    [
                                        ...
                                        'value'=>$id_array[$counter]]).
                                "</div></div>";
                            /*foreach ($rental_room_beds as $arb){
                                if ($arb->bed_room_id == $ab->id){
                                    debug($arb->rental_id);
                ...
                <!-- Tenants -->
                <input type="hidden" value="<?php echo $this_rental->number_of_tenant; ?>" id="num-ppl">
                <div id="tent" class="control-group">
                    ...
                    <?php
                    // hidden number_of_tenant field

                    echo "<input name='number_of_tenant' id='number-of-tenant' type='hidden' value='".$this_rental->number_of_tenant."'>";
                    $this->Form->unlockField('tenants._ids');
                    $this->Form->unlockField('number-of-tenant');
                    $this->Form->unlockField('number_of_tenant');
                    for ($i=0; $i<99; $i++){
                        $this->Form->unlockField('tenant.old.'.$i.'.id');
                        $this->Form->unlockField('tenant.old.'.$i.'.first_name');
                        $this->Form->unlockField('tenant.old.'.$i.'.last_name');
                        $this->Form->unlockField('tenant.old.'.$i.'.preferred_name');
                        $this->Form->unlockField('tenant.old.'.$i.'.gender');
                        $this->Form->unlockField('tenant.old.'.$i.'.is_aus_citizen');
                        $this->Form->unlockField('tenant.old.'.$i.'.personal_contact_phone');

                        $this->Form->unlockField('tenant.new.'.$i.'.first_name');
                        $this->Form->unlockField('tenant.new.'.$i.'.last_name');
                        $this->Form->unlockField('tenant.new.'.$i.'.preferred_name');
                        $this->Form->unlockField('tenant.new.'.$i.'.gender');
                        $this->Form->unlockField('tenant.new.'.$i.'.is_aus_citizen');
                        $this->Form->unlockField('tenant.new.'.$i.'.personal_contact_phone');

                        $this->Form->unlockField('tenant.removed.'.$i);
                    }

                    $i = 0;
                    //debug($applicants);
                    foreach ($tenants as $applicant){
                        $tag_id = "tenant".$i;
                        ?>
                        ...
                        <div class="tent_field" id="<?php echo $tag_id; ?>">
                            <div  style="border-radius: 10px; border: solid 1px #ffc107;">
                                <div style="padding-left:10px;">
                                    ...
                                    <div>
                                        <input type="hidden" id="rm_<?php echo $i; ?>" name="tenant[old][<?php echo $i; ?>][id]" value="<?php echo $applicant->id; ?>">
                                        <div class="inline_field">
                                            <?php
                                            echo $this->Form->control('tenant.old.'.$i.'.first_name',
                                                ['label' => 'First Name',
                                                    'type' => 'text',
                                        ...
                                        <div class="inline_field">
                                            <?php
                                            echo $this->Form->control('tenant.old.'.$i.'.last_name',
                                                ['label' => 'Last Name',
                                                    'type' => 'text',
                                        ...
                                        <div class="inline_field">
                                            <?php
                                            echo $this->Form->control('tenant.old.'.$i.'.preferred_name',
                                    ...
                                    <div class="inline_field" style="padding-top:10px;">
                                        <?php   echo $this->Form->control(
                                            'tenant.old.'.$i.'.personal_contact_phone',
                                            ['label' => 'Personal Phone (Autralian preferred)',
                                                'type'  => 'text',
                                                'placeholder' => '04',
                                                'class' => 'span3',
                                                'style' => 'height:35px;',
        ...
        <?php echo $this->Form->button('Save Rental',
            ['type' => 'submit',
        ...
        <?php
        $c_d = new \Cake\I18n\Time();
        $c_d =  $this->Time->format($c_d,'dd/MM/Y');
        $this->Form->unlockField('current_date');
        ?>
        <input type="hidden" name="current_date" value="<?php echo $c_d; ?>">
...
<script>
    function finalValidate(){
        ...
        $('#number-of-tenant').prop('value', $('.tent_field').length);
...
<script>
    ...
    function validateDate(){
        ...
        if (room_type == 0){                                                                                            // private room check
            ...
            if (currentDate < e){
                ...
                let resArray = <?php echo json_encode($resArray); ?>;
            ...
            if (se < currentDate) {                                                                                      // if ends before today, no validation
                ...
                for (let i=0; i < bedCapBigger.length; i++){                                                            // disable showing error msg
    ...
    function selectBeds(){
         ...
         */
        let displayedBeds = document.getElementsByClassName('sharedRoomBedCheck');
        let selectedBeds = <?php echo json_encode($this_room_bed); ?>;
        console.log("????????????????????????????");
    ...
    function calBedCap(){
        ...
        console.log("======.my_bed:checkbox:checked==========================");
        console.log(selectedBeds);
        let cap = 0;
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.rm', function(){
            ...
            if ($('.tent_field').length > 1){
                // before remove add to removed list
                let rm_ref = document.getElementById('rm_ref');
                let rm_counter = document.getElementById('rm_counter');
                let rm_entry = document.createElement('input');

                let id_id = '#rm_'+ $(this)[0].id.split('removetenant')[1];
                //console.log(id_id);
                //console.log($(id_id).val());
                let this_value = $(id_id).val();

                if (this_value != 'new'){
                    rm_entry.setAttribute('value', this_value);
                    rm_entry.setAttribute('name', 'tenant[rm]['+rm_counter.value+']');
                    rm_entry.setAttribute('type', 'hidden');
                    rm_counter.setAttribute('value', parseInt(rm_counter.value)+1);
                    rm_ref.appendChild(rm_entry);
                }
        ...
        function addTenant(){
            ...
            hidden_id.setAttribute('value', 'new');
            hidden_id.setAttribute('id', 'rm_'+i);
            ...
            let name_text = "tenant[new]["+i+"][first_name]";
            ...
            name_text = "tenant[new]["+i+"][last_name]";
           ...
           // pn_input.setAttribute('required', 'false');
            ...
            second_outter_div.appendChild(hidden_id);
            ...
            name_text = "tenant[new]["+i+"][is_aus_citizen]";
            ...
            ph_input_inner.innerHTML = "" +
                "<label for=\"tenant-new-"+i.toString()+"-personal-phone\">Personal Phone (Australian preferred)</label>" +
                "<input type=\"text\" " +
                "name=\"tenant[new]["+i.toString()+"][personal_contact_phone]\"  " +
                "placeholder=\"04\" " +
                "class=\"span3\" " +
                "style=\"height:35px;\" " +
                ...
                "<br><span>If you don't have an Australian phone number, please enter your country code before the phone number. Possible format: +86 18844576263</span><br><br>";
...
<Script>
    ...
    function showBedTentWarning_error(){
        ...
        let currentBedCap = calFullBedCap();
        //alert(currentBedCap);
        if (room_type == 1){
        ...
        if (currentBedCap >= currentNumTent){
            if (room_type == 0){
                ...
                let sstep1errormsg = document.getElementsByClassName('step1ErrorMsg');                                  // room ava at this time slot > num tent, hide error msg
                for (let i=0; i<sstep1errormsg.length; i++){
                    sstep1errormsg[i].setAttribute('style', 'display:none;');
                }
            }
            ...
            if (room_type == 0){
                ...
                let sstep1errormsg = document.getElementsByClassName('step1ErrorMsg');                               // room ava at this time slot < num tent, show error msg
                for (let i=0; i<sstep1errormsg.length; i++){
                    sstep1errormsg[i].setAttribute('style', 'padding-top:10px;');
                }

                let bedCapBigger = $('.bedCapBigger');// hide warning
                for (let i=0; i < bedCapBigger.length; i++){
                    bedCapBigger[i].setAttribute('style', 'display:none');
                }
            }
            return false;                                                                                               // due to error return false
        }
