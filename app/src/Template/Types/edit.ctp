...
<head>
    ...
    <title>Edit Property Type | Admin</title>
    <?php $this->assign("title","Edit Property Type | NAIM Admin"); ?>
</head>
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <?= $this->Form->create($type, ['id' => 'myform']) ?>
        <div class="module">
                ...
                <div class="form-horizontal row-fluid">
                    <div class="control-group">
                        <fieldset>
                            <div>
                                <?php
                                echo $this->Form->control('name', ['label' =>'Change Property Type Name', 'type' => 'text',
                    ...
                    <div class="control-group">
                        <h4>This Property Type is included in the below Properties</h4>
        ...
        <?php echo $this->Form->button('Save Property Type',
            ['type' => 'submit',
                'class' => 'button btn-success span11',
                'style' => 'border-radius: 8px;',
                'confirm' => 'Are you sure you want to save your changes on this Property Type for all the properties?',
            ]); ?>
        <?= $this->Form->end() ?>
